...
$route['admin/update-pengguna/(:any)'] = 'admin/edit_user/';
$route['admin/hapus-pengguna/(:any)'] = 'admin/delete_user/';
$route['admin/simpan-departemen'] = 'admin/add_dept';
$route['admin/update-departemen/(:any)'] = 'admin/edit_dept/';
$route['admin/hapus-departemen/(:any)'] = 'admin/delete_dept/';
$route['admin/proses-tiket/(:any)'] = 'admin/resolve_ticket/';
$route['admin/kirim-ulang-persetujuan/(:any)'] = 'admin/resend_approval/';
