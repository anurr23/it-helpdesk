...
<div class="glass-card w-100 overflow-hidden d-flex flex-column shadow-sm mx-auto" style="max-width: 800px;">
    <div class="px-4 py-3 border-bottom d-flex align-items-center justify-content-between" style="background: rgba(255,255,255,0.6); border-color: rgba(255,255,255,0.7) !important;">
        <div class="d-flex align-items-center gap-2">
            ...
            <div>
                <h5 class="mb-0 fw-bold text-slate-800">Edit Profil Pengguna</h5>
                <div class="text-slate-500" style="font-size: 13px;">Ubah detail informasi pengguna sistem.</div>
            </div>
        </div>
    ...
    <div class="p-4" style="background: rgba(255,255,255,0.4);">
        <?= form_open('admin/update-pengguna/' . $target_user->id) ?>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="name" value="<?= htmlspecialchars($target_user->name) ?>" class="form-control form-control-lg bg-white border-0 shadow-sm" style="font-size: 14px;" required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="username" value="<?= htmlspecialchars($target_user->username) ?>" class="form-control form-control-lg bg-white border-0 shadow-sm" style="font-size: 14px;" required>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="contact" value="<?= htmlspecialchars($target_user->contact) ?>" class="form-control form-control-lg bg-white border-0 shadow-sm" style="font-size: 14px;">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" name="email" value="<?= htmlspecialchars($target_user->email) ?>" class="form-control form-control-lg bg-white border-0 shadow-sm" style="font-size: 14px;">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="input-group-select2">
                        ...
                        <select name="role" class="form-select select2-glass" style="font-size: 14px;" required>
                            <option value="user" <?= $target_user->role == 'user' ? 'selected' : '' ?>>User Standar</option>
                            <option value="admin" <?= $target_user->role == 'admin' ? 'selected' : '' ?>>Admin IT</option>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="input-group-select2">
                        ...
                        <select name="dept" class="form-select select2-glass" style="font-size: 14px;">
                            ...
                            <?php foreach($departments as $d): ?>
                                <option value="<?= $d->id ?>" <?= $target_user->dept == $d->id ? 'selected' : '' ?>><?= htmlspecialchars($d->dept_name) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="form-check form-switch mt-2 bg-white p-3 rounded-3 shadow-sm d-flex align-items-center gap-2">
                        <input class="form-check-input ms-0 mt-0" type="checkbox" role="switch" name="atasan" value="T" id="flexSwitchAtasan" style="width: 40px; height: 20px; cursor: pointer;" <?= $target_user->atasan == 'T' ? 'checked' : '' ?>>
                        <div class="ms-2">
                            <label class="form-check-label fw-bold text-slate-800" for="flexSwitchAtasan" style="cursor: pointer;">Status Approver / Atasan</label>
                ...
                <div class="col-12">
                    ...
                    <div class="input-group">
                        <span class="input-group-text bg-white border-0 shadow-sm"><span class="material-symbols-outlined text-slate-400" style="font-size: 20px;">lock_reset</span></span>
                        <input type="text" name="password" class="form-control form-control-lg bg-white border-0 shadow-sm" style="font-size: 14px;" placeholder="Ketik di sini untuk mereset password. Biarkan kosong jika tidak diubah.">
                    </div>
                    <div class="form-text mt-2 text-slate-500" style="font-size: 12px;">
                        <span class="material-symbols-outlined align-middle text-warning" style="font-size: 16px;">warning</span> Jika dikosongkan, pengguna tetap menggunakan sandi lama mereka.
                    </div>
                </div>
            </div>

            <div class="mt-5 d-flex justify-content-end gap-3">
                <a href="<?= base_url('admin/pengguna') ?>" class="btn btn-light rounded-pill px-4 shadow-sm fw-medium d-flex align-items-center">Batal Perubahan</a>
