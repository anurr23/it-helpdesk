                ...
                <div class="col-12">
                    <div class="mt-2 bg-white p-3 rounded-3 shadow-sm">
                        <label class="custom-checkbox-wrapper d-flex align-items-start gap-3 w-100 m-0">
                            <input type="checkbox" name="atasan" value="T" id="flexSwitchAtasan" class="custom-checkbox-input" <?= $target_user->atasan == 'T' ? 'checked' : '' ?>>
                            <div class="custom-checkbox-box mt-1 flex-shrink-0"></div>
                            <div>
                                <span class="custom-checkbox-label d-block fw-bold text-slate-800" style="font-size: 14px;">Status Approver / Atasan</span>
